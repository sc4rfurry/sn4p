...
<h4 align="center">A Blazing Fast and Relaible alternative to netcat.</h4>
<div style="text-align:center">
    ...
    <img src="https://img.shields.io/badge/Version-1.0.0alpha-informational?style=flat-square&logo=github&logoColor=white&color=5194f0&bgcolor=110d17" alt="Version">
...
- git clone https://github.com/sc4rfurry/sn4p.git
- cd sn4p
- go get .
- go build main.go
